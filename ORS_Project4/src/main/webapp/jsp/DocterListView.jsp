<%@page import="com.rays.pro4.Bean.DocterBean"%>
<%@page import="com.rays.pro4.controller.DocterListCtl"%>
	...
	<form action="<%=ORSView.DOCTER_LIST_CTL%>" method="post">
		...
		<center>
			...
			<%
				...
				Iterator<DocterBean> it = list.iterator();
			...
			<table width="100%" align="center">
				<tr>
					...
					<td align="center"><label>Name</font> :
						...
						value="<%=DocterListCtl.OP_RESET%>"></td>
				</tr>
			</table>
			<br>
			...
			<table border="1" width="100%" align="center" cellpadding=6px
				...
				<tr align="center">
					...
					<td><a href="DocterCtl?id=<%=bean.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>
			...
			<table width="100%">
				<tr>
					...
					<td><input type="submit" name="operation" disabled="disabled"
						value="<%=DocterListCtl.OP_PREVIOUS%>"></td>
					<%
						} else {
					%>
			...
			<td align="center"><input type="submit" name="operation"
				value="<%=DocterListCtl.OP_BACK%>"></td>
			<%
				}
			%>
